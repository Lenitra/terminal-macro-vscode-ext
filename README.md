...
| `terminalMacros.closeTerminalOnFinish` | `true` | Ferme le terminal dès que la commande est terminée. Décocher pour garder la sortie à l'écran : le même terminal est alors réutilisé à chaque exécution. |
